...
[`nvtop-exporter_0.0.6_linux_amd64.AppImage`](https://github.com/spotdemo4/nvtop-exporter/releases/tag/v0.0.6)

```console
$ chmod +x nvtop-exporter_0.0.6_linux_amd64.AppImage
$ ./nvtop-exporter_0.0.6_linux_amd64.AppImage
2026-02-23 11:52:09,536 - INFO - Starting server on :8080
```
...
[Service]
ExecStart=/usr/local/bin/nvtop-exporter_0.0.6_linux_amd64.AppImage
Type=simple
Restart=on-failure
...
```elm
docker run ghcr.io/spotdemo4/nvtop-exporter:0.0.6
```
...
services:
  nvtop-exporter:
    image: ghcr.io/spotdemo4/nvtop-exporter:0.0.6
    pid: host
    ports:
      - "8080:8080"
