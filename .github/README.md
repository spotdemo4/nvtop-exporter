...
[![pypi](https://img.shields.io/pypi/v/nvtop-exporter?logo=pypi&logoColor=%23bac2de&labelColor=%23313244&color=%23306998)](https://pypi.org/project/nvtop-exporter/)
...
[`nvtop-exporter_0.0.7_linux_amd64.AppImage`](https://github.com/spotdemo4/nvtop-exporter/releases/tag/v0.0.7)

```console
$ chmod +x nvtop-exporter_0.0.7_linux_amd64.AppImage
$ ./nvtop-exporter_0.0.7_linux_amd64.AppImage
2026-02-23 11:52:09,536 - INFO - Starting server on :8080
```
...
[Service]
ExecStart=/usr/local/bin/nvtop-exporter_0.0.7_linux_amd64.AppImage
Type=simple
Restart=on-failure
...
```elm
docker run ghcr.io/spotdemo4/nvtop-exporter:0.0.7
```
...
services:
  nvtop-exporter:
    image: ghcr.io/spotdemo4/nvtop-exporter:0.0.7
    pid: host
    ports:
      - "8080:8080"
